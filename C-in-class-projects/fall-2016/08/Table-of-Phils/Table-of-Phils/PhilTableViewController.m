...
@property (strong, nonatomic) NSArray *phils;
...
- (void)viewDidLoad {
    ...
    _phils = [[NSArray alloc] init];
    [self setValue:_phils forKey:@"phils"];
...
{
    [[self mutableArrayValueForKey:@"phils"] addObject:[[NSDate date] description]];
    
    NSIndexPath *indexPath = [NSIndexPath indexPathForRow:_phils.count-1 inSection:0];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        [[self mutableArrayValueForKey:@"phils"] removeObjectAtIndex:indexPath.row];
